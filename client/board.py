...
class Board(object):
    ...
    def draw(self, win):
        pygame.draw.rect(win, (0, 0, 0), (self.x - self.BORDER_THICKNESS/2, self.y-self.BORDER_THICKNESS/2,
                         self.WIDTH + self.BORDER_THICKNESS, self.HEIGHT + self.BORDER_THICKNESS), self.BORDER_THICKNESS)
    ...
    def click(self, x, y):
       ...
       # aucun si pas dans le bord, sinon retournez la place cliquée
       # en termes de ligne et de collonne
       # :param x: float
       #:param y: float
