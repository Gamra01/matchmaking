#Stocker l'interface pour bouton et deux classes de boutons concrets
#à utiliser dans l'interface utilisateur.
import pygame
...
class Button:
    ...
    def draw(self, win):
        ...
        pygame.draw.rect(win, self.color, (
            self.x + self.BORDER_WIDTH, self.y +
            self.BORDER_WIDTH, self.width - self.BORDER_WIDTH * 2,
...
class TextButton(Button):
    ...
    def draw(self, win):
        ...
        win.blit(txt, (self.x + self.width/2 - txt.get_width() /
                 2, self.y + self.height/2 - txt.get_height()/2))
