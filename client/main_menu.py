#Affiche le menu principal du jeu puis on obtient le nom d'utilisateur avant de commencer
    ...
    def draw(self):
        ...
        if self.waiting:
            ...
            enter = self.enter_font.render(
                "Press enter to join a game...", 1, (0, 0, 0))
            self.win.blit(enter, (self.WIDTH / 2 - title.get_width() / 2, 800))
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    if event.key == pygame.K_RETURN:
                        ...
                        # convertit en majuscules le nom de la clé
