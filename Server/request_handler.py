...
class Server(object):
    ...
    def player_thread(self, conn, player):
        """
        gère dans le jeu la communication entre les clients
        """
        while True:
            try:
                try:
                ...
                # Le joueur n'est pas en dehors du jeu
    ...
    def handle_queue(self, player):
        """
       ajouter le joueur à la fil d'attente  et crée un nouveau jeu si suffisamment de joueurs
        :param player: Player
        :return: None
        """
    ...
    def connection_thread(self):
        server = "161.97.142.25" # 161.97.142.25
        port = 5556
